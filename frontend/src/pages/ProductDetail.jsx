  ...
  return (
    <div className="px-[5%] py-10 bg-white min-h-[calc(100vh-65px)]">
      ...
      <div className="flex gap-12 flex-wrap">
        <div className="flex-1 min-w-[300px] bg-gray-50 rounded-[30px] p-10 flex items-center justify-center border border-gray-100">
          <img src={product.image} alt={product.name} className="max-w-full h-auto rounded-xl shadow-2xl shadow-green-900/5 transition-transform hover:scale-105 duration-500" />
        </div>
        ...
        <div className="flex-1 min-w-[300px] text-left">
          ...
          <div className="flex items-center gap-6 mb-10 bg-gray-50 w-fit p-2 rounded-[20px] border border-gray-100">
            <button
          ...
          <div className="flex gap-4 mb-10">
            <button
              className="flex-1 py-4.5 bg-primary text-white border-none rounded-2xl text-lg font-black flex items-center justify-center gap-3 cursor-pointer shadow-xl shadow-green-900/15 hover:bg-secondary transition-all active:scale-[0.98]"
              onClick={() => addToCart(product, quantity)}
            >
              <ShoppingCart size={22} />
              Add to Bag
            </button>
            <button className="p-4.5 bg-red-50 text-red-400 border border-red-100 rounded-2xl cursor-pointer hover:bg-red-400 hover:text-white transition-all active:scale-[0.98]">
