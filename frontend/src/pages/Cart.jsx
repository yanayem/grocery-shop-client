  ...
  return (
    <div className="px-[5%] py-10 min-h-[calc(100vh-65px)]">
      ...
      <div className="flex gap-10 flex-wrap">
        ...
        <div className="flex-1 min-w-[300px] bg-[#f8fdf9] p-8 rounded-2xl h-fit border border-gray-100">
          ...
          <div className="mt-8 space-y-4">
            ...
            <button
              className="w-full py-4 bg-primary text-white border-none rounded-xl text-lg font-bold mt-8 cursor-pointer shadow-lg shadow-green-900/10 hover:bg-secondary transition-colors"
